...
export default class Settings {
    ...
    updateData(opentypeFont) {
        ...
        this.settings = {
            ...
            toolBoxCheckers: [true, true, false, this.featureLists[0] ? true : false, true],
            basicControls: {
                "Size": { min: 10, max: 300, default: window.matchMedia('(max-width: 768px)').matches ? 30 : 50, step: 1, prop: "fontSize", unit: "px" },
